				...
				<div class="p-6 space-y-4 md:space-y-6 sm:p-8">
					...
					<div id="form" class="space-y-4 md:space-y-6">
						...
						<p class="text-sm font-light text-gray-500 dark:text-gray-400 mt-2">
							Already have an account? <nuxt-link to="/login/" class="font-medium text-blue-600 hover:underline dark:text-blue-500">Login here</nuxt-link>>
						</p>
						</FormKit>
						</div>
					<div v-if="submitted">
						<h2 class="text-green-600">Successfully created an account!</h2>
					</div>
				</div>
			</div>
		</div>
