...
<template>
    <div class="mt-10 p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800">
        <div class="mx-auto max-w-screen-xl text-center">
            ...
            <p class="my-6 text-gray-500 dark:text-gray-400">Plattform for making posts, reading posts, and providing information.</p>
            ...
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="#" class="hover:underline">The Blog™</a>. All Rights Reserved.</span>
        </div>
      </div>
</template>
