	...
	<div id="container-navbar" class="w-full py-6 text-onPrimary bg-primary">
		<div id="navbar" class="h-[50px] mx-auto flex items-center max-w-[1000px] bg-primary justify-between">
			...
			<span class="flex items-center">
				...
				<span v-if="authStore?.isAuthenticated" id="new-post" class="me-4 flex items-center flex-col">
					<NuxtLink to="/newpost"><svg class="mb-1 w-7 h-auto fill-onPrimary hover:fill-onPrimaryFixed"
					...
					<span class="text-xs"><NuxtLink to="/newpost">Nytt innlegg</NuxtLink></span>
				</span>

				<span v-if="authStore?.isAuthenticated" class="me-4 flex items-center flex-col">
					<NuxtLink to="/minkonto"><svg class="mb-1 w-8 h-auto fill-onPrimary hover:fill-onPrimaryFixed"
							xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
							<path
					...
					<span class="text-xs"><NuxtLink to="/minkonto">Min profil</NuxtLink></span>
				</span>
				...
				<span v-if="authStore?.isAuthenticated" class="me-4 flex items-center flex-col">
					...
					<span class="text-xs"><NuxtLink to="/loggut">loggut</NuxtLink></span>
				</span>
