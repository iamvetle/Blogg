...
<div class="bg-primary-base">
	...
	<div class="flex items-center">
		...
		placeholder="Søk.." @keyup.enter="trySearch">
	</div>
	<div id="nav-menu" class="flex text-center items-center p-6">
		...
		<li @click="toggleSearch" id="search-icon" class="text-white sm:hidden flex flex-col me-4">
			<svg xmlns="http://www.w3.org/2000/svg" class="mx-auto h-6 hover:h-7 w-auto fill-white" viewBox="0 0 24 24">
			<path
	...
	<input id="mobile_input" v-if="mobileSearch" v-model="search_input" autofocus type="text"
	class="sm:hidden flex rounded-md h-10 mx-auto w-8/12 mb-5 bt-4" placeholder="Søk.." @keyup.enter="trySearch">
</div>
</template>
...
/** Represents a menu bar that is shown when there is 'mobile' size */
const mobileSearch = ref(false)

/** Function deals with regulating the menu bar */
const toggleSearch = () => {
