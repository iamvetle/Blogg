...
<template>
  <div class="bg-primary-base">
    <div
      id="navbar"
      class="h-16 justify-between flex items-center p-6 md:10/12 sm:w-11/12 w-12/12 mx-auto"
    >
      <div class="flex items-center">
        <h2 class="text-white text-2xl flex ms-8 me-6">
          <nuxt-link to="/">
            Bloggen
          </nuxt-link>
        </h2>
      ...
      <div
        id="nav-menu"
        class="flex text-center items-center p-6"
      >
        <ul class="flex items-center">
          <li
            id="search-icon"
            class="text-white sm:hidden flex flex-col me-4"
            @click="toggleSearch"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="mx-auto h-6 hover:h-7 w-auto fill-white"
              viewBox="0 0 24 24"
            ><path d="M18.031 16.6168L22.3137 20.8995L20.8995 22.3137L16.6168 18.031C15.0769 19.263 13.124 20 11 20C6.032 20 2 15.968 2 11C2 6.032 6.032 2 11 2C15.968 2 20 6.032 20 11C20 13.124 19.263 15.0769 18.031 16.6168ZM16.0247 15.8748C17.2475 14.6146 18 12.8956 18 11C18 7.1325 14.8675 4 11 4C7.1325 4 4 7.1325 4 11C4 14.8675 7.1325 18 11 18C12.8956 18 14.6146 17.2475 15.8748 16.0247L16.0247 15.8748Z" /></svg>
            <p class="text-xs sm:block hidden text-center" />
          </li>
          <li
            id="new-post"
            class="text-white flex text-center flex-col me-4"
          >
            <nuxt-link to="/newpost">
              <svg
                ...
                class="mx-auto h-6 hover:h-7 w-auto fill-white"
                viewBox="0 0 24 24"
              ><path d="M14 3V5H4V18.3851L5.76282 17H20V10H22V18C22 18.5523 21.5523 19 21 19H6.45455L2 22.5V4C2 3.44772 2.44772 3 3 3H14ZM19 3V0H21V3H24V5H21V8H19V5H16V3H19Z" /></svg>
              <p class="text-xs sm:block hidden text-center">
                Nytt innlegg
              </p>
            </nuxt-link>
          ...
          <li
            id="user-account"
            class="text-white flex text-center flex-col me-8"
          >
    ...
    <input
      ...
      autofocus
      type="text"
      class="sm:hidden flex rounded-md h-10 mx-auto w-8/12 mb-5 bt-4"
      placeholder="Søk.."
      @keyup.enter="trySearch"
    >
  </div>
