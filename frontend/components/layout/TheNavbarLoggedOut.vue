	...
	<div class="bg-primary-base">
		<div id="navbar" class="h-16 justify-between flex items-center p-6 md:10/12 sm:w-11/12 w-12/12 mx-auto">
			...
			<div id="nav-menu" class="flex text-center items-center p-6">
				<ul class="flex items-center me-8">

					<li id="new-post" class="flex items-center me-4">
						<nuxt-link to="/login">
							<p class="text-plain">Logg inn</p>
						</nuxt-link>
					</li>
					<li id="user-account" class="flex items-center bg-primary-high hover:bg-primary-600 border-primary-high shadow-md rounded-lg px-3 py-2">
						<nuxt-link to="/register">
							<p class="text-white ">Registrer</p>
						</nuxt-link>
					</li>
