<template>
  <div class="">
    <div class="pt-10 p-4 bg-primary w-full ">
      <div class="mx-auto max-w-screen-xl text-onPrimary text-center">
        ...
        <span class="text-sm text-onPrimary sm:text-center">
          <div class="pb-4">
            © 2023
            <a href="#" class="hover:underline">The Blog™</a>. All Rights
            Reserved.
          </div>
        </span>
      </div>
