...
<template>
	<div class="bg-primary-high">
		<div id="navbar" class="text-white h-16 justify-between flex items-center p-6 md:10/12 sm:w-11/12 w-12/12 mx-auto">
			...
			<div id="nav-menu" class="flex items-center p-6">
				<ul class="flex items-center">
					...
					<li id="new-post" class="flex flex-col me-4">
						<svg xmlns="http://www.w3.org/2000/svg" class="h-6 hover:h-7 w-auto fill-white" viewBox="0 0 24 24"><path d="M14 3V5H4V18.3851L5.76282 17H20V10H22V18C22 18.5523 21.5523 19 21 19H6.45455L2 22.5V4C2 3.44772 2.44772 3 3 3H14ZM19 3V0H21V3H24V5H21V8H19V5H16V3H19Z"></path></svg>
						<p class="text-xs sm:flex hidden">Nytt innlegg</p>
					</li>
					<li id="user-account" class="flex flex-col me-8">
						...
						<p class="text-xs sm:flex hidden">Min side</p>
					</li>
					<!-- <li id="logout">
